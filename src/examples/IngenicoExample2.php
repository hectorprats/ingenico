    ...
    */
    public function getInputFields()
    {
        ...
        */
        ...
        $inputs['customer-billingAddress'][] = ['type' => 'text', 'name' => 'bi_state',   'value' => 'M'];
        ...
        $inputs['customer-billingAddress'][] = ['type' => 'text', 'name' => 'bi_additionalInfo', 'value' => '4 b'];
        //Company Information
        $inputs['customer-companyInformation'][] = ['type' => 'text', 'name' => 'ci_name', 'value' => 'SW'];
        //Contact Details
        $inputs['customer-contactDetails'][] = ['type' => 'text', 'name' => 'cd_emailAddress', 'value' => 'billy.ardela+ingenico@smallworldfs.com'];
        ...
        $inputs['customer-personalInformation'][] = ['type' => 'text', 'name' => 'dateOfBirth', 'value' => ''];
        $inputs['customer-personalInformation'][] = ['type' => 'select', 'name' => 'gender', 'options' => ['male','female']];
        $inputs['customer-personalInformation'][] = ['type' => 'text', 'name' => 'pi_firstName', 'value' => ''];
        $inputs['customer-personalInformation'][] = ['type' => 'text', 'name' => 'pi_surname', 'value' => ''];
        $inputs['customer-personalInformation'][] = ['type' => 'text', 'name' => 'pi_surnamePrefix', 'value' => ''];
        $inputs['customer-personalInformation'][] = ['type' => 'text', 'name' => 'pi_title', 'value' => ''];
        ...
        $inputs['order-references'][] = ['type' => 'text', 'name' => 'merchantReference', 'value' => ''];
        ...
        */
        ...
        $inputs['fraud'][] = ['type' => 'text', 'name' => 'orderTimezone', 'value' => 'ES']; //ISO 3166 2
